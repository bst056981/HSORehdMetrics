...
namespace Agile.Helper {
    public class signOnDBHelper {
        #region ConnectionString, Database
        public static string ConnString {
            get {
                return WebConfigurationManager.ConnectionStrings["signOnConnectionString"].ConnectionString;
            }
        }

        private static OracleConnection getConnection() {
            OracleConnection retVal = new OracleConnection(signOnDBHelper.ConnString);
            retVal.Open();
            return retVal;
        }
        ...
        public static void Execute(string sql, params object[] paramList) {
            ...
            //   USE BELOW TO SEE YOUR PARAMETERS
            string outputText;

            if (cmd.Parameters.Count == 0)
            {
                outputText = cmd.CommandText;
            }
            else
            {
                ...
                {
                    p = (IDataParameter)cmd.Parameters[i];
