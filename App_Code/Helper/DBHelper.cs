...
namespace Agile.Helper {
    public class DBHelper {
        ...
        public static void Execute(string sql, params object[] paramList) {
            ...
            cmd.Transaction = tx;
            cmd.CommandText = sql;
            System.Diagnostics.Debug.WriteLine("Command Text........ " + cmd.CommandText);
            addParamters(cmd, paramList);
            foreach (OracleParameter pam in paramList)
            {
                System.Diagnostics.Debug.WriteLine("Parameters........" + pam.ToString());
                System.Diagnostics.Debug.WriteLine("Parameters........" + pam.Value);
            }
            cmd.ExecuteNonQuery();
            tx.Commit();
            tx.Dispose();
